...
import DonateeShopListScreen from "./DonateeShopListScreen";
...
function HawkerList({ navigation }) {
    ...
    return (
      <Item
        ...
        onPress={() => {
          ...
          navigation.navigate("DonateeShopList", { ...item });
        }}
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.header}>Hawker Centres</Text>
      <FlatList
...
export default function HawkerScreen() {
  return (
    <HawkerStack.Navigator>
      <HawkerStack.Screen
        name="DonateeHawkerList"
        component={HawkerList}
        options={{ headerShown: false }}
      />
      <HawkerStack.Screen
        name="DonateeShopList"
        component={DonateeShopListScreen}
        options={{ headerShown: false }}
      />
    </HawkerStack.Navigator>
  );
